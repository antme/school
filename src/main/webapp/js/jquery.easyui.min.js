...
if(_88=="manual"){
$("<span style=\"padding-left:6px;\"></span>").html("第").appendTo(tr).wrap("<td></td>");
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"显示 {from} 到   {to} 总共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
},message:"请输入正确的邮箱地址"},url:{validator:function(_443){
